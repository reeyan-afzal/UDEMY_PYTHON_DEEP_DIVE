...
We just need an initialized counter that returns the next value every time it is called.
...
So moral of the story here, is don't just jump into solving every problem using classes - this isn't Java, and we don't need a class for everything!
