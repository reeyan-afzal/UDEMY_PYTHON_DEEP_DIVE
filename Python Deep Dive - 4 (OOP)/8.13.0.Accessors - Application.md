...
Next, we define the `DBTable` class. It will be initialized with the name of the table we want to use in our instance. Furthermore, we'll make it callable (passing in the record id) and that should return an instance of `DBRecord` for the particular record.
...
Now we can use our classes this way:
