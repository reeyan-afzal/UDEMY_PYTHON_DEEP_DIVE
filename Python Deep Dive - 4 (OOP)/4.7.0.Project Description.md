...
- `died(n)` : method to return and permanently remove inventory from the pool (e.g. they broke something) - as long as the total available allows it
...
Next, we are going to define child classes for each CPU, HDD, and SDD.
