...
If the **first line** in the function body is a strong (not an assignment, not a command, just a string by itself), it will be interpreted as a **docstrings** 
...
It doesn't really! It mainly used by external tools and modules. Example: apps that generate documentation from your code (Sphinx)
