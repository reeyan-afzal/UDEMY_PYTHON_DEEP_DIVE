...
- `def __init__(self, width, height):`: This is the constructor method. It initializes a new instance of the class. The first argument is always `self`, which refers to the instance being created.
