...
![[Assets/course1_snippets/2.9.VariableEquality.png]]
...
```python
a = None
b = None #Thoughout the lifetime of the application the memory address will be the same for all three variables
c = None
```
...
None in Python doesn't mean to nothing it is an actual object.
