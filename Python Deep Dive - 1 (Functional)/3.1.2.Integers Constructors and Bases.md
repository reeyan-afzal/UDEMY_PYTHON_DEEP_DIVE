...
![[Assets/course1_snippets/3.1.1.IntegersOperations-2.png]]
...
![[Assets/course1_snippets/3.1.1.IntegersOperations-3.png]]
...
The simplest way to do this given a list of a digits to encode, is to create a string with as many characters as needed, and use their index (ordinal position) for our encoding map 
