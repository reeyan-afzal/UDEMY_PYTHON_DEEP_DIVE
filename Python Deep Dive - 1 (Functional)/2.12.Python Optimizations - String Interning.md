...
In which case we can use ```a is b``` instead - which compares two **integers** (memory address) this is **much** faster than the character by character comparison
...
In general though, you don't need to intern strings yourself. Only do this if you really need to.
