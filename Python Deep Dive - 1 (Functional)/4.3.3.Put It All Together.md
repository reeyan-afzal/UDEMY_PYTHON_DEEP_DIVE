...
![[../Assets/course1_snippets/4.3.3.PutItAllTogether-1.png]]
#### Examples
...
![[../Assets/course1_snippets/4.3.3.PutItAllTogether-2.png]]
...
Often, keyword-only arguments are used to modify the default behavior of a function. Such as the the ```print()``` function. 
